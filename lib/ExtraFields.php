        ...
        foreach ($extraFields as $index => $data) {
            switch ($data['extraFieldType']) {
                ...
                case EXTRA_FIELD_RADIO:
                    ...
                    foreach ($options as $option) {
                        if ($option != '') {
                            $extraFields[$index]['addHTML'] .= '<label class="extra-field-radio__label" for="extraField-' . $index . '__' . htmlspecialchars(urldecode($option)) . '"><input class="extra-field-radio__input" type="radio" id="extraField-' . $index . '__' . htmlspecialchars(urldecode($option)) . '" name="extraField' . $index . '" value="' . htmlspecialchars(urldecode($option)) . '"><span class="extra-field__value">' . htmlspecialchars(urldecode($option)) . '</span></label>';
                        }
                    }
                    break;
